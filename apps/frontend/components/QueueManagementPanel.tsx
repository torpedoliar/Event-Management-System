...
export default function QueueManagementPanel({ isOpen, onClose }: QueueManagementPanelProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-brand-secondary border border-brand-border rounded-xl shadow-2xl max-w-2xl w-full max-h-[85vh] overflow-hidden flex flex-col">
        {/* Header */}
        <div className="px-6 py-4 border-b border-brand-border flex items-center justify-between bg-brand-secondary/50">
        ...
        {/* Tabs */}
        <div className="flex border-b border-brand-border bg-brand-secondary/30">
          <button
        ...
        <div className="flex-1 overflow-y-auto px-6 py-4 custom-scrollbar">
          {currentQueue.length === 0 ? (
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between text-xs font-semibold text-white/40 uppercase tracking-widest mb-2">
                  ...
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <div className="flex flex-col items-end gap-2">
                       ...
                       <button
                        ...
                        className="p-1.5 text-white/30 hover:text-brand-danger hover:bg-brand-danger/10 rounded transition-all"
        ...
        {/* Footer Actions */}
        {currentQueue.length > 0 && (
          <div className="px-6 py-4 border-t border-brand-border bg-brand-secondary/50 space-y-3">
            <div className="flex gap-3">
              ...
              <button
                ...
                disabled={isSyncing || currentQueue.length === 0}
                className="flex-1 px-4 py-3 bg-white/5 hover:bg-brand-danger hover:text-white text-white/60 font-medium rounded-lg border border-white/10 transition-all active:scale-95"
              >
                Clear All
              </button>
            </div>
